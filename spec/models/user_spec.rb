...
describe User do
  ...
  it "should accept valid email addresses" do
    addresses = %w[user@foo.com THE_USER@foo.bar.org first.last@foo.jp foo+bar@baz.net]
  ...
  describe "micropost associations" do
    ...
    it "should have the right microposts in the right order newest to oldest" do
  ...
  describe "relationships" do
    ...
    it "should include the follower in the following array" do
      @user.follow!(@followed)
